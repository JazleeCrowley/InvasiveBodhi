# Invasive Bodhi
Chapter 3 of Dissertation focusing on the introduction of the Bodhi tree on the Hawaiian Islands. [Here is a table](./Figures/Island_Comparison/Total_Hawaii_trees.png) with all Bodhi tree occurrences on all three islands, with a total of 714 occurrences.
## Project Objectives
